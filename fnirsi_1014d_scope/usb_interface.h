...
//Needs confirmation about register sizes and the used address.
//Some of the definitions use(d) 32 bit type on non 32 bit alligned address
...
#define USBC_REG_DEVCTL       ((volatile uint8  *)(0x01c13041))
...
#define USBC_REG_VEND1        ((volatile uint8  *)(0x01c1307D))
#define USBC_REG_VEND3        ((volatile uint8  *)(0x01c1307E))

#define USBC_REG_EPINFO       ((volatile uint8  *)(0x01c13078))
#define USBC_REG_RAMINFO      ((volatile uint8  *)(0x01c13079))
#define USBC_REG_LINKINFO     ((volatile uint8  *)(0x01c1307A))
#define USBC_REG_VPLEN        ((volatile uint8  *)(0x01c1307B))
#define USBC_REG_HSEOF        ((volatile uint8  *)(0x01c1307C))
#define USBC_REG_FSEOF        ((volatile uint8  *)(0x01c1307D))
#define USBC_REG_LSEOF        ((volatile uint8  *)(0x01c1307E))
